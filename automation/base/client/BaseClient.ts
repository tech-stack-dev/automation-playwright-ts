...
export default class BaseClient implements APIRequestContext {
    public static focusedClient: BaseClient;
    public static listOfClients: BaseClient[] = [];
    ...
    public get ClientContext(): APIRequestContext {
        return BaseClient.focusedClient._clientContext;
    }

    public set ClientContext(value: APIRequestContext) {
        BaseClient.focusedClient._clientContext = value;
    }
